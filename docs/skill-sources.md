...
league-of-agents-platform vendors its `.claude/skills/` from **guildmaster** — the
...
Every vendored `SKILL.md` carries `type: command`. league-of-agents-platform
...
#   - consumer-identifying prose: `guildmaster` → `league-of-agents-platform` (NOT
...
If a re-sync would lose a league-of-agents-platform adaptation, lift the change
...
#     → `which league-of-agents-platform vendors from guildmaster`
