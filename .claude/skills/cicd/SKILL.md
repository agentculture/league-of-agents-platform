...
type: command
description: >
  league-of-agents-platform's CI/CD lane, layered on `devex pr`. Delegates lint / open /
  ...
  unresolved threads). Use when: creating PRs in league-of-agents-platform, handling
...
# CI/CD — league-of-agents-platform edition
