...
description: >
  ...
  defaults queries to this agent's PERSONAL, PRIVATE scope (`--scope league-of-agents-platform
...
- `--scope NAME` / `--visibility public|private` — scope isolation (no private
  ...
  (`--scope league-of-agents-platform --visibility private`, suffix read from `culture.yaml`),
