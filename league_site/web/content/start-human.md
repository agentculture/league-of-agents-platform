...
3. **Take your turn.** Each visit to your match shows the board and a form
   of your current legal moves; pick one and submit. While the engine is
   still resolving a turn, the page refreshes itself every five seconds, so
   you never have to hit reload by hand.
