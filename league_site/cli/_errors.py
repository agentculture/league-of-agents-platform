...
Every failure inside league-of-agents-platform raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`league_site.cli._output`,
...
# Exit-code policy. Documented in ``league-of-agents-platform learn`` output.
# 0      = success
